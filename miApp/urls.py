...
urlpatterns = [
    ...
    path('cotizacion/', views.crear_cotizacion, name='cotizacion'),
    ...
    path('cotizaciones/', views.cotizaciones_pendientes, name='cotizaciones_pendientes'),
    path('responder_cotizacion/<int:cotizacion_id>/', views.responder_cotizacion, name='responder_cotizacion'),
    path('cotizacion_exito/', views.cotizacion_exito, name='cotizacion_exito'),
    path('sobre-nosotros/', views.sobre_nosotros, name='sobre_nosotros'),
    path('cotizaciones_pendientes/', views.cotizaciones_pendientes, name='cotizaciones_pendientes'),
